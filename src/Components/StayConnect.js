                ...
                <motion.button whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }} >
                    <div className="flex flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
                        <div className="flex flex-row">
                            ...
                            <button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-violet-400 border-slate-400 border dark:text-gray-900">Subscribe</button>
                        </div>
                    </div>
                </motion.button >
            </div>
